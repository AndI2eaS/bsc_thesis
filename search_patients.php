<?php
	...
	$sql = "SELECT * FROM patient WHERE pat_name LIKE '$search_words[0]%' AND pat_surname LIKE '$search_words[1]%' OR pat_name LIKE '$search_words[1]%' AND pat_surname LIKE '$search_words[0]%'";
	$res = mysql_query($sql);
