<?php
	...
	if (isset($_POST['submit'])) 
	{
		foreach ($_POST as $key => $value) 
		{
			...
			if ($key != "submit") 
			{
			   $sql = mysql_query("UPDATE private_messages SET sender_delete='1', opened='1' WHERE mes_id='$id' AND from_id='" . $_SESSION['user_id'] . "' LIMIT 1");
			}
		}
		header("location: pm_sentbox");
	}
						...
						<tr>
							<td width="732" valign="top">
								<form name="form" action="" method="POST" enctype="multipart/form-data">
									...
									$sql = "SELECT * FROM private_messages WHERE from_id='" . $_SESSION['user_id'] . "' AND sender_delete='0' ORDER BY mes_id DESC";
									...
									while($row = mysql_fetch_array($result)){
										...
										$sql1 = "SELECT user_id, username, user_type FROM user WHERE user_id='$to_id' LIMIT 1";
									...
									?>
										<table width="96%" border="0" align="center" cellpadding="5">
											<tr>
												...
												<td width="20%" valign="top"><a href="profile?id=<?php echo $f_id; ?>"><?php echo $f_name; ?></a></td>
												<td width="58%" valign="top">
													<span class="show_message" style="padding:3px;">
														<a id="subject_line_<?php echo $row['mes_id']; ?>" style="cursor:pointer;"><?php echo stripslashes($row['subject']); ?></a>
													</span>
